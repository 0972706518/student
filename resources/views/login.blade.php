...
<div class="py-4 fon text-center">
    <h1>
        ...
        <strong>慈濟科技大學<div class="d-block d-lg-inline"></div>學生資訊系統</strong>
    </h1>
</div>    
...
<div class="container text-center pt-2 pb-5">
    <form method="POST" action="{{ route('login') }}">
            {{ csrf_field() }}
        <div class="stu ">
            <strong><span>請使用Email及密碼進行登入</span></strong>
        </div>
        <div class="stu ">
            <span>Login With Your Email<div class="d-block d-lg-inline"></div> And Password</span>
        </div>
